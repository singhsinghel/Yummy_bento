      ...
      <div className="header-contents d-flex flex-column align-items-start gap-4">
        ...
        <form action="">
          ...
          <button className='btn col-lg-2 col-3  menu-btn btn-light px-3 fw-bold rounded-start-4 rounded-end-0' style={{color:'#747474'}}> View menu</button>
            <input type="text" placeholder='Search Dishes'  className="query col-lg-8  col-6 border-0" />
            <button className='btn col-3 col-lg-2 btn-light px-5 fw-bold rounded-end-4 rounded-start-0' style={{color:'#747474'}}>Search</button>
          </div>
        </form>
        </div>
      </div>
