        ...
        {food_list.map((item, index) => {
          if (cartItems[item._id] > 0) {
            return (
              <div
                key={index}
                className="cart-items-title cart-items-item row mt-3 text-center"
              >
            ...
            <div className="row">
              <div className="input col-7 p-0 position-relative">
                <input
                  ...
                  style={{
                    borderRadius: showCoupons ? "4rem !important" : "0",
                  }}
                  type="text"
                    ...
                    >
                      <ul>
                        {coupons.map((item, index) => (
                          <li
                            className="cursor-pointer fw-light"
                            key={index}
              ...
              <button
                type="submit"
                className="btn btn-dark col-3 rounded-start-0"
              >
                Submit
              </button>
            </div>
